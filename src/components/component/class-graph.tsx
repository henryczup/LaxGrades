                    ...
                    <div className="mt-6 lg:mt-0 lg:col-span-3">
                        ...
                        <div className="grid grid-flow-col gap-4">
                            <div className="bg-[#f6f6ef] p-4 rounded-lg">
                                ...
                                <p className="text-3xl font-bold text-red-800">{Object.values(aggregateDistribution).reduce((a, b) => a + b, 0)}</p>
                            </div>
                            <div className="bg-[#f6f6ef] p-4 rounded-lg">
                                <h3 className="text-lg font-semibold text-gray-900">Average GPA</h3>
                                <p className="text-3xl font-bold text-red-800">{calculateAverageGPA(aggregateDistribution)}</p>
                            </div>
                            <div className="bg-[#f6f6ef] p-4 rounded-lg">
                                <h3 className="text-lg font-semibold text-gray-900">Percentage A</h3>
                                <p className="text-3xl font-bold text-red-800">{calculatePercentageA(aggregateDistribution)}%</p>
                            </div>
                        </div>
                    </div>
                </div>
